...
<div id="form-wrapper">
    ...
    <form action="userSave.action" method="get">

        <div id="form-inner">

            <label>姓名:</label>

            <input  class="input" name="user.username" placeholder="姓名">

            <label >密码:</label>

            <input name="user.password" class="input"  placeholder="密码" type="password">
           
             <label >等级:</label>

            <input name="user.level" class="input"  placeholder="等级" >
       ...
       <footer id="footer">footer页面</footer>
  </section>
